...
const item = {
  path: `${REPL_AI_PGF_FORUM_CONTRACT}/profile/**`,
};
      ...
      Near.asyncView(REPL_SOCIAL_CONTRACT, "get", {
        ...
        try {
          ...
          const lastAboutTextFromSocialDB =
            result["${REPL_AI_PGF_FORUM_CONTRACT}"].profile.description;
...
return (
  <Container>
    ...
    <div className="tab-content" id="editPreviewTabsContent">
      ...
      >
        <Widget
          src={`${REPL_AI_PGF_FORUM}/widget/components.molecule.SimpleMDE`}
          props={{
