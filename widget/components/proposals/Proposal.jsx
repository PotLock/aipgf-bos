...
const proposal = Near.view("${REPL_AI_PGF_FORUM_CONTRACT}", "get_proposal", {
...
const proposalURL = getLinkUsingCurrentGateway(
  `${REPL_AI_PGF_FORUM}/widget/app?page=proposal&id=${proposal.id}&timestamp=${snapshot.timestamp}`,
);
          ...
          <div className="d-flex flex-wrap gap-6">
            ...
            >
              ...
              <div className="border-bottom pb-4 mt-4">
                <Widget
                  src={`${REPL_AI_PGF_FORUM}/widget/components.proposals.CommentsAndLogs`}
                  props={{
                    ...props,
                    id: proposal.id,
                    item: item,
            ...
            >
              ...
              >
                <Widget
                  src={`${REPL_AI_PGF_FORUM}/widget/components.molecule.LinkedRfps`}
                  props={{
