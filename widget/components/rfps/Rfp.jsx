...
} = VM.require(`${REPL_AI_PGF_FORUM}/widget/core.common`) || {
  RFP_TIMELINE_STATUS: {},
  fetchGraphQL: () => {},
  CANCEL_RFP_OPTIONS: {},
  parseJSON: () => {},
...
const rfp = Near.view("${REPL_AI_PGF_FORUM_CONTRACT}", "get_rfp", {
  rfp_id: parseInt(id),
});
...
const item = {
  type: "social",
  path: `${REPL_AI_PGF_FORUM_CONTRACT}/post/main`,
  blockHeight,
};
const rfpURL = getLinkUsingCurrentGateway(
  `${REPL_AI_PGF_FORUM}/widget/app?page=rfp&id=${rfp.id}&timestamp=${snapshot.timestamp}`,
);
...
const accessControlInfo =
  Near.view("${REPL_AI_PGF_FORUM_CONTRACT}", "get_access_control_info") ?? null;
const moderatorList =
...
return (
  <Container className="d-flex flex-column gap-2 w-100 mt-4">
    <Widget
      src={`${REPL_AI_PGF_FORUM}/widget/components.rfps.ConfirmCancelModal`}
      props={{
    ...
    />
    <Widget
      src={`${REPL_AI_PGF_FORUM}/widget/components.rfps.WarningModal`}
      props={{
    ...
    <div className="d-flex flex-wrap flex-md-nowrap px-3 px-lg-0 gap-2 align-items-center text-sm pb-3 w-100">
      <Widget
        src={`${REPL_AI_PGF_FORUM}/widget/components.rfps.StatusTag`}
        props={{
          ...
          <div className="d-flex flex-wrap gap-6">
            ...
            >
                ...
                <RfpContainer className="rounded-2 flex-1">
                  ...
                  <div className="d-flex flex-column gap-1 p-2 px-3 description-box">
                    <div className="text-muted h6 border-bottom pb-1 mt-3">
                      ...
                      <div className="my-2">
                        <Widget
                          src={`${REPL_AI_PGF_FORUM}/widget/components.molecule.MultiSelectCategoryDropdown`}
                          props={{
                    ...
                    <div className="d-flex gap-2 align-items-center mt-4">
                      <Widget
                        src={`${REPL_AI_PGF_FORUM}/widget/components.molecule.LikeButton`}
                        props={{
                          item,
                          rfpId: rfp.id,
              ...
              <div className="border-bottom pb-4 mt-4">
                <Widget
                  src={`${REPL_AI_PGF_FORUM}/widget/components.rfps.CommentsAndLogs`}
                  props={{
                    ...props,
                    id: rfp.id,
                    item: item,
              ...
              >
                <Widget
                  src={`${REPL_AI_PGF_FORUM}/widget/components.molecule.ComposeComment`}
                  props={{
                    ...props,
                    item: item,
                    notifyAccountIds: moderatorList,
            ...
            >
              ...
              >
                <Widget
                  src={`${REPL_AI_PGF_FORUM}/widget/components.rfps.TimelineConfigurator`}
                  props={{
                    timeline: timeline,
                    setTimeline: (v) => {
                      if (
              ...
              >
                <Widget
                  src={`${REPL_AI_PGF_FORUM}/widget/components.molecule.LinkedProposals`}
                  props={{
