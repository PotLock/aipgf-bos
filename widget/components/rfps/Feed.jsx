...
const getRfp = (rfp_id) => {
  return Near.asyncView("${REPL_AI_PGF_FORUM_CONTRACT}", "get_rfp", {
    rfp_id,
  });
};
    ...
    <Container className="w-100 py-4 px-2 d-flex flex-column gap-3">
      <div className="d-flex justify-content-between flex-wrap gap-2 align-items-center">
        ...
        <div className="d-flex flex-wrap gap-4 align-items-center">
          ...
          />
          <Widget
            src={`${REPL_AI_PGF_FORUM}/widget/components.molecule.FilterByLabel`}
            props={{
              onStateChange: (select) => {
          ...
          <div className="d-flex gap-4 align-items-center">
            <Widget
              src={`${REPL_AI_PGF_FORUM}/widget/components.rfps.StageDropdown`}
              props={{
                onStateChange: (select) => {
        ...
        {!Array.isArray(state.data) ? (
          ...
          <div className="card no-border rounded-0 mt-4 py-3 full-width-div">
            <div className="container-xl">
              <div>
                <Widget
                  src={`${REPL_AI_PGF_FORUM}/widget/components.pages.announcement`}
                  loading=""
                />
              </div>
